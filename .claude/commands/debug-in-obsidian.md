...
This workflow builds the Obsidian plugin, launches it inside the real Obsidian app, captures structured logs via Playwright + CDP, and iteratively fixes any errors found.
