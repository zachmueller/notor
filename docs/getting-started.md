...
1. Open **Settings → Notor → Tools → Shared settings**
2. Under **Additional file-system paths**, click **Add path** and enter a directory the tools should be able to access (e.g. `~/Documents`). The vault root is always implicitly allowed — no need to add it.
