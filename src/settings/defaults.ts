...
export function createDefaultSettings(configDir: string): NotorSettings {
	...
	os_notifications_completion_enabled: false,
	os_notifications_input_required_enabled: false,
	os_notifications_only_when_app_inactive: true,
	os_notifications_coalesce_approvals: "per_call",
