...
export class NotorSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		const orchestrationGroup = createSettingsGroup(containerEl, "Orchestration", false, persisted, onToggle);
		renderOrchestrationSection(orchestrationGroup, ctx);
