...
const EDIT_NOTOR_SETTINGS: BuiltinToolScaffold = {
	name: "edit_notor_settings",
	description: "Change a single Notor plugin setting by key path.",
	mode: "write",
	scaffoldContent:
`---
notor-type: tool
notor-tool-name: edit_notor_settings
notor-description: "Change a single Notor plugin setting by key path."
notor-mode: write
---

Customizable override for the built-in \`edit_notor_settings\` tool. Edit the code below and reload extensions to apply changes.
