...
Follow the commit standards defined in `.clinerules/git.md` to commit the new checklist file(s).
...
- Optional: `speckit-03-plan.md` workflow for technical requirements
