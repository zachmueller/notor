...
Follow the commit standards defined in `.clinerules/git.md` to commit all implementation changes and updated artifacts.
...
- Completed task breakdown (`speckit-05-tasks.md` workflow)
...
- Run `speckit-07-analyze.md` workflow for cross-artifact consistency validation
